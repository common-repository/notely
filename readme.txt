...
Description:        Create admin text notes for any post, page or custom post type.
Tags:               notes, memo, post notes, page notes
...
* Go to <strong>Settings</strong> -> <strong>Notely</strong>, choose which post types to enable for and any other options.
* Hit the <strong>Save Settings</strong> button.
* You will now see a <strong>Notes</strong> metabox when you create or edit.
...
Yes. <a href="https://rocketapps.com.au/product/notely-pro/?origin=notely">Notely Pro</a> has more features.

== Official website and support ==

* <a href="https://wordpress.org/support/plugin/notely">Notely support</a>
* More options with <a href="https://rocketapps.com.au/product/notely-pro/?origin=notely">Notely Pro</a>
* <a href="https://rocketapps.com.au/shop/?origin=notely">More awesome plugins</a>
* <a href="https://rocketapps.com.au/wproject-theme/?origin=notely">Project Management built on WordPress</a>
